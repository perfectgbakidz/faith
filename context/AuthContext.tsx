...
interface AuthContextType {
  ...
  logout: () => void;
  // FIX: Corrected type for register function's userData parameter to exclude fields generated by the API.
  register: (userData: Omit<User, 'id' | 'role' | 'userIdNumber' | 'pictureIdUrl'>) => Promise<void>;
}
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // FIX: Corrected type for register function's userData parameter to match what apiRegister expects.
  const register = async (userData: Omit<User, 'id' | 'role' | 'userIdNumber' | 'pictureIdUrl'>) => {
    try {
